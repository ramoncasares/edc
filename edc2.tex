...
ignoramos lo que va a ocurrir, pero sabemos cómo tiene que ser la
^estadística^ de lo que suceda. Si lo ignoramos todo, entonces ni la
...
ley probabilística.
$$\hbox{Indeterminación}\llave{Azar\cr Desconocimiento\cr Libertad}$$
...
albedrío^, o al desconocimiento de todas las circunstancias y procesos
cerebrales que intervienen en sus decisiones.
...
contrario, se utilizan cuando se ignoran las causas. Las leyes
...
elimina al ^azar^ como fuente de indeterminación. No hay azar, sino
^desconocimiento^ y ^libertad^.
$$\hbox{Ignorancia}\llave{Desconocimiento\cr Libertad}$$

La ^vida^ se juega en la ^ignorancia^, entre el desconocimiento y la
...
La ^aleatoriedad^ es una propiedad del ^objeto^. La ^ignorancia^ es el
estado natural del ^sujeto^. La ^libertad^ es la ignorancia referida al
futuro. El ^desconocimiento^ es la ignorancia referida al pasado. La
aleatoriedad es la proyección de la ignorancia del sujeto sobre el
objeto. La ^probabilidad^ es una herramienta que usa el sujeto para
describir lo que él conoce, a pesar de su ignorancia intrínseca.
...
Le propongo elevar a postulado la ignorancia del sujeto, ¿se atreve?
...
simpre le disipa alguna ^incertidumbre^ y le añade conocimiento. Ya
