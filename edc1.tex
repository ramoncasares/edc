...
naturales es culpable. Solamente _Dios<único responsable> es
responsable; usted y yo no. Y, para aquellos materialistas que no creen
en Dios, nunca nadie es culpable de nada, sino que simplemente ocurre
así.
...
digo. La ^televisión^, el ^teléfono^ y la ^bomba atómica^ son productos
...
objetos es que así se _simplifica<comprimir> el enorme caudal de datos
