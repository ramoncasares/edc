...
\catcode`\ö=13 \defö{\"o} % Gödel, Schrödinger
...
\pdfcode
 \def\watermark{% 
  ...
  \pdfliteral{115 -32 50 -48 48 -55 c}% % s 2007
  \pdfliteral{b Q}%
 }
...
\input auxiliar.toc
 ...
 \centerline{\hbox{%
  \pdfximage width 8cm {1938-Bugatti-Type-57SC-Atlantic-Rear.jpg}%
 ...
 del Profesor D.~E.~Knuth (Stanford University).
